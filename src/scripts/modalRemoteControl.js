  ...
  <ion-header>
    <ion-toolbar color="tertiary">
      <ion-buttons slot="start">
          <ion-button>
              <ion-icon src="https://raw.githubusercontent.com/deckgo/deckdeckgo-website/master/src/assets/icons/ionicons/close.svg" ariaLabel="Close"></ion-icon>
          </ion-button>
      </ion-buttons>
...
function getRemoteControlModalContent() {
    ...
    <div class="qrcode-container" style="display: flex; justify-content: center;  --deckgo-qrcode-size: 300px; --deckgo-qrcode-color-fill: var(--ion-color-tertiary);">
        <deckgo-qrcode content="${qrCodeLink}">
            <ion-icon slot="logo" src="https://raw.githubusercontent.com/deckgo/deckdeckgo-website/master/src/assets/icons/deckdeckgo.svg"></ion-icon>
        </deckgo-qrcode>
    </div>`;
    }
}
